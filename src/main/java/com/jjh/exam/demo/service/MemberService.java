...
public class MemberService {
	...
	public ResultData<Integer> join(String loginId, String loginPw, String name, String nickname, String cellphoneNo, String email) {
		...
		// 별명,폰번호,이메일 중복체크
		oldMember = getMemberByNickNameNPhoneNEmail(name, email);
		if (oldMember != null) {
...
//		loginPw = Ut.sha256(loginPw);
	...
	// 중복체크
	private Member getMemberByNickNameNPhoneNEmail(String name, String email) {
		return memberRepository.getMemberByNickNameNPhoneNEmail(name, email);
	}
